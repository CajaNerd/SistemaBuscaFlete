...
<html lang="en">
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand pacifico" href="index.php">Busca Flete</a>
        </div>
    ...
    <div class="jumbotron camion">
      <div class="container">
        <p class="blanco"> ¡Correo ya registrado en nuestros sistemas!  D:</p>
        <p><a class="btn btn-primary btn-lg"  href="../login.php">Volver al Login&raquo;</a></p>
      </div>
    </div>
